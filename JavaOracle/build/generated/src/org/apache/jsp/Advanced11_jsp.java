...
public final class Advanced11_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
            ...
            //κλήση σε CURSOR
            ResultSet MyCursor;
            CallableStatement cs2=conn.prepareCall("begin open ? for SELECT  POLITICS.GOVERNMENT,COUNT(POLITICS.COUNTRY) FROM POLITICS,ISMEMBER WHERE POLITICS.COUNTRY=ISMEMBER.COUNTRY AND ISMEMBER.ORGANIZATION='EU' GROUP BY POLITICS.GOVERNMENT ; end;");
      ...
      out.write("        data.addColumn('string', 'Politics');\n");
      out.write("        data.addColumn('string', 'Number');\n");
      ...
      out.write("          title: 'Largest Cities in the World'\n");
      out.write("        };\n");
      out.write("\n");
      ...
      out.write("    <div id=\"piechart\" style=\"width: 900px; height: 500px; float: left;  background: orange; margin: 20px\">test2</div>\n");
