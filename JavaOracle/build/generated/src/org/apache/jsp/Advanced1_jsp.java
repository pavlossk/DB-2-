...
public final class Advanced1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
            ...
            //κλήση σε CURSOR
            ResultSet MyCursor;
            CallableStatement cs2=conn.prepareCall("begin open ? for SELECT COUNTRY.NAME,COUNTRY.POPULATION,COUNTRY.CAPITAL FROM ISMEMBER,COUNTRY  WHERE ISMEMBER.COUNTRY=COUNTRY.CODE  AND ORGANIZATION='NATO' ORDER BY COUNTRY.POPULATION DESC;  end;");
      ...
      out.write("          ");
          ...
          while (MyCursor.next())
            {
                out.println("['"+MyCursor.getString(1)+"','"+MyCursor.getString(3)+"','"+MyCursor.getString(2)+"'],");
            }
      ...
      out.write("          title: 'Countries in NATO'\n");
      out.write("        };\n");
      out.write("\n");
      ...
      out.write("    <div id=\"piechart\" style=\"width: 900px; height: 600px; float: left;  background: orange; margin: 20px\">test2</div>\n");
      out.write("    <br>\n");
      out.write("    <div>\n");
