...
public final class Advanced13_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
            ...
            //κλήση σε CURSOR
            ResultSet MyCursor;
            CallableStatement cs2=conn.prepareCall("begin ADVANCED13(?); end;");
      ...
      out.write("        data.addColumn('string', 'Lake');\n");
      out.write("        data.addColumn('string', 'Area');\n");
      out.write("        data.addColumn('string', 'Number of Cities');\n");
      ...
      out.write("          ['Country','Area','Number of Cities'],\n");
      out.write("          ");
              ...
              while ( MyCursor .next())
                {
                    out.println("['"+ MyCursor.getString(1)+"','"+MyCursor.getString(3)+"',"+MyCursor.getString(4)+"],");
                }
